...
void initialize()
{
    ...
    FILE *fpt;
    char c;
    A = (double **)malloc(nreal*sizeof(double));
    for (i=0; i<nreal; i++)
    {
        A[i] = (double *)malloc(nreal*sizeof(double));
    }
    B = (double *)malloc(nreal*sizeof(double));
...
void initialize()
{
    ...
    A = (double **)malloc(nreal*sizeof(double));
    B = (double **)malloc(nreal*sizeof(double));
    alpha = (double *)malloc(nreal*sizeof(double));
    for (i=0; i<nreal; i++)
    {
        A[i] = (double *)malloc(nreal*sizeof(double));
        B[i] = (double *)malloc(nreal*sizeof(double));
    }
